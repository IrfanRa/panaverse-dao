    ...
    const programsData = [
         ...
         //program 2
        {
          slug: "ai",
            ...
            description: "he AI and Deep Learning specialization focuses on building and deploying intelligent APIs using OpenAI models and building custom Deep Learning Tensorflow models.",
            image: ai,
            quarters: [
                {
                    header: "Quarter IV",
    ...
    <section>
      <Wrapper>
        ...
        <div className="mt-10 flex flex-col-reverse lg:flex-row gap-x-6 gap-y-8">
          {/* Content Left */}
          <div className=" shadow-xl self-start sticky top-28 basis-8/12 rounded-xl border border-slate-300 px-8 py-8">
            ...
            <button className="text-primary font-semibold text-xl mt-4  underline flex items-end">
              Learn More 
              <svg className="mb-1 ml-1"
                width="10"
                height="13"
                viewBox="0 0 8 11"
                fill="none"
          ...
          {/* Content Right */}
          <div className="px-4 space-y-4 py-6 bg-slate-100 basis-4/12 ">
            {
