...
const outcomePoints = ["Product Ownershop", "Freelancing", "Global Marketing by DAO", "Boosting Economy."]
            ...
            <div className='flex gap-x-8 items-center flex-col-reverse md:flex-row'>
                ...
                {/* Right contet */}
                    <div className="flex-1">
                        ...
                        <p className='mt-4 text-slate-600 text-lg'>As a graduate of this program, you will own valuable products such as Full-Stack App Templates, 
                            AR and VR Experiences, and APIs that are marketed globally by the Panaverse DAO. You will also have the opportunity to offer your services
                            at a rate of $50 per hour, providing a path to financial stability while contributing to the growth of Pakistan software exports.</p>
                        <div className='mt-6 grid grid-cols-2 gap-x-2 gap-y-4'>
                            {
                                outcomePoints.map((item, i) => (
                                    <div key={i} className='flex items-center gap-x-2'>
                                        <svg width="52" className='flex-shrink-0' height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path fillRule="evenodd" clipRule="evenodd" d="M17 24.9206C19.0707 25.3461 21.734 26.1698 23.75 27.465C26.1177 24.3345 30.371 21.406 35 19C30.6042 23.2739 26.9667 28.1236 24.5 33C22.5117 30.2129 20.3398 27.6189 17 24.9206Z" fill="white"/>
                                        <defs>
